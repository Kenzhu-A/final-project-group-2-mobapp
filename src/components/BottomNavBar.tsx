...
interface Props {
  ...
  unreadMessageCount?: number; // [MESSAGE-BADGE]
}
...
export default function BottomNavBar({
  ...
  return (
    <View
      style={[
        styles.container,
        { backgroundColor: colors.surface, bottom: insets.bottom + 4 },
      ]}
    >
      {NAV_ITEMS.map((item) => {
            ...
            {item.isCenter ? (
              ...
              >
                <View style={{ position: "relative" }}>
                  ...
                  />
                  {/* [MESSAGE-BADGE] Show badge on messages tab */}
                  {item.id === "messages" &&
                    !!unreadMessageCount &&
